#!/bin/bash
#SBATCH -J dshmm-k16384-dp0-nb128-spw128-d256                         # Job name
...
py14env
python main.py --lr 0.01 --column_dropout 1 --transition_dropout 0 --model dshmm --assignment brown --states_per_word 128 --num_clusters 128 --num_classes 16384 --bsz 512
