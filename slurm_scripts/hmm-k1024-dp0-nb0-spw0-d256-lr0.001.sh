#!/bin/bash
#SBATCH -J hmm-k1024-dp0-d256-lr0.001                         # Job name
...
py14env
python main.py --lr 0.001 --column_dropout 1 --transition_dropout 0 --dropout_type none --model hmm --bsz 128 --num_classes 1024 --emb_dim 256 --hidden_dim 256
