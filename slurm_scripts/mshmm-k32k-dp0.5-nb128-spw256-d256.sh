#!/bin/bash
#SBATCH -J mshmm-k32768-dp0.5-nb128-spw256-d256                         # Job name
...
py14env
python main.py --lr 0.01 --column_dropout 1 --transition_dropout 0.5 --model mshmm --assignment brown --states_per_word 256 --num_clusters 128 --num_classes 32768 --bsz 512
