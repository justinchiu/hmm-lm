#!/bin/bash
#SBATCH -J mshmm-k65536-dp0.5-nb32-spw1024-d256-lr0.001                         # Job name
...
py14env
python main.py --lr 0.001 --column_dropout 1 --transition_dropout 0.5 --model mshmm --assignment brown --states_per_word 512 --num_clusters 128 --num_classes 65536 --bsz 512 --eval_bsz 2048
