#!/bin/bash
#SBATCH -J mshmm-k16384-dp0.5-nb256-spw64-d512-lr0.01                         # Job name
...
py14env
python main.py --lr 0.01 --column_dropout 1 --transition_dropout 0.5 --model mshmm --assignment brown --states_per_word 64 --num_clusters 256 --num_classes 16384 --bsz 512 --eval_bsz 512
