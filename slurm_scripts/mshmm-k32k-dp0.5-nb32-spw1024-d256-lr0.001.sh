...
py14env
python main.py --lr 0.001 --column_dropout 1 --transition_dropout 0.5 --model mshmm --assignment brown --states_per_word 1024 --num_clusters 32 --num_classes 32768 --bsz 512
