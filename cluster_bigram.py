...
chp_path4 = "wandb_checkpoints/shmm_k1024_wps512_spw256_ed256_d256_dp0_tdp0.25_cdp1_sdp0_tokens_b512_adamw_lr0.01_c5_tw_nas0_pw1_asbrown_nb4_nc0_ncs0_spc0/39239_5.16.pth"
# this one is broken
chp_path_broken = "wandb_checkpoints/shmm_k1024_wps512_spw128_ed256_d256_dp0_tdp0.5_cdp1_sdp0_tokens_b256_adamw_lr0.01_c5_tw_nas0_pw1_asbrown_nb8_nc0_ncs0_spc0/176648_5.30.pth"
...
emission = model.mask_emission(model.emission_logits, model.word2state)
emission[emission < -1e10] = -1e10
H = th.distributions.Categorical(logits=emission).entropy()[:-1]
print(H.min().item(), H.mean().item(), H.median().item(), H.max().item())

import pdb; pdb.set_trace()
"""

bigram_counts = th.zeros(dtype=th.long)
